...
// const createUsernames=function(user){const username=user.toLowerCase().split(' ').map(name=> name[0]).join(''); return username;}
...
currenciesUnique.forEach(function(value,_,map){        //(value,key,map){
